...
<div class="container">
    ...
    <input class="btn-default btn-md" type="button" value="已刪除的歌曲" onclick="location.href='list_deleted.php'">
    </h3>
    <div class="row">
        <div class="panel panel-primary filterable">
            ...
            <table id="tablesorter" class="table">
                ...
                ?>
                        <td><input class="btn-primary" type="button" value="修改" onclick="location.href='edit.php?no=<?php echo $row['no'];?>'"></td>
                        <td><input class="btn-danger" type="button" value="刪除" onclick="location.href='action/delete.php?no=<?php echo $row['no'];?>'"></td>
                    </tr>
                <?php
                        }
                    }
